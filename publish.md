...
- **Version dynamique** : La version source est définie dans [src/vtherm_api/__init__.py](src/vtherm_api/__init__.py) (`__version__ = "0.5.0"`). `pyproject.toml` la lit dynamiquement.
